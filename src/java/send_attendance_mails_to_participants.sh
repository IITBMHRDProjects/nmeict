...
$JAVA_HOME/bin/javac -cp ".:$REQ1:$REQ2:$REQ3:$CLASS_Path" $SOURCE_FILES/org/project/misc/SendMail_Attendance.java

$JAVA_HOME/bin/java -cp ".:$REQ1:$REQ2:$REQ3:$CLASS_Path" org/project/misc/SendMail_Attendance
