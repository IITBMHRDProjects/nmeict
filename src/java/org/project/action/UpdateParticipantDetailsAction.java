 ...
 * @author asl
 */
public class UpdateParticipantDetailsAction extends ActionSupport {
    ...
    public String execute() throws Exception {
        ...
        //fetching the arraylist of cities
//        setCities(process.listCity(getPerson().getInstitute().getState().getStateId()));
        //fetching the arraylist of institutes
//        setInstitutes(process.listInstitute(getPerson().getInstitute().getCity().getCityId()));

        //code added by abinaya
        ...
        remotecenterList = process.listRemoteCenters(wcid, state);
        if (workshopContent.get(0).getCategorycode() == 5 || workshopContent.get(0).getCategorycode() == 7 || workshopContent.get(0).getCategorycode() == 8) {
            ArrayList<RemoteCenterCapacity> rcc = process.rccDetails1(Integer.parseInt(wcid), participantDetails.getRemoteCenter().getRemoteCenterId());
