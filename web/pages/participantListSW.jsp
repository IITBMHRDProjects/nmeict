<%-- 
    Document   : participantListSW
    Created on : Aug 29, 2016, 11:26:06 AM
    Author     : abinaya
--%>
...
<script type="text/javascript">
    function changeTest(workshopid, status) {
        ...
        window.location.href = "participantListSW.html?workshopid=" + workshopid + "&status=" + status + "&state=" + rcid + "&callFrom=" +<%=callFrom%>;
    }
...
//        fetchParticipantDetailsSW(rcid, workshopid, status);
//        fetchParticipantCountSW(rcid, workshopid, status);
    }
            ...
            <s:if test="%{categorycode == 8 && without_RC == 1}">
                <div id="hideTable">
                    <table class="content_container" >
                        <tr><td>State : </td><td><select class="displayselect" id="rcid" name="remotecenter" onchange="changeTest('<s:property value="workshopid_encrypted"/>', '<s:property value="status_encrypted"/>');" >
        ...
        <tr>
            ...
            <th>Designation</th>
                ...
                <s:if test="%{categorycode == 4 && respectiveCoWorkshopid == 0}">
                    ...
                    <s:if test="%{(categorycode == 5 && without_RC == 0) || categorycode == 7 || (categorycode == 8 && without_RC == 0)}">  
                    <th>Remote Center</th>                    
                    </s:if>
                    <s:if test="%{(categorycode == 5 && without_RC == 1) || categorycode == 7 || (categorycode == 8 && without_RC == 1)}">  
                    <th>Institute</th>
                    </s:if>
                </s:iterator>
            <th>State</th>
