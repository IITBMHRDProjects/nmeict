<%-- 
    Document   : doUpdateConfigSuccess
    Created on : 23 Feb, 2015, 9:08:07 AM
    Author     : Abinaya
--%>
...
<body>
    ...
    <div class="form_enclosure">
        ...
        <p>To go back to the View Configuration table interface</p>
        <p>Click Here ----> <a href="viewConfigTables.html">View Configuration Table</a></p>
